...
def meet_team():
    ...
    st.markdown(
        ...
        <div style="display: flex; justify-content: space-between;">
            <div class="card1">
                <img class="profile-image" src="data:image/svg+xml;base64,{image_to_base64('/Users/SHAD/code/Parvxi/Peaklytics/.streamlit/app_pages/images/1.svg')}" alt="Sabah Baothman">
            ...
            <div class="card2">
                <img class="profile-image" src="data:image/svg+xml;base64,{image_to_base64('/Users/SHAD/code/Parvxi/Peaklytics/.streamlit/app_pages/images/2.svg')}" alt="Shahad Hatim">
                <div class="card__content">
            ...
            <div class="card3">
                <img class="profile-image" src="data:image/svg+xml;base64,{image_to_base64('/Users/SHAD/code/Parvxi/Peaklytics/.streamlit/app_pages/images/3.svg')}" alt="Joud Alharbi">
                <div class="card__content">
            ...
            <div class="card4">
                <img class="profile-image" src="data:image/svg+xml;base64,{image_to_base64('/Users/SHAD/code/Parvxi/Peaklytics/.streamlit/app_pages/images/4.svg')}" alt="Somayah">
                <div class="card__content">
