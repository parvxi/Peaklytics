...
# Main Page
def page1():
    image_base64 = get_base64_image("/home/joud/code/parvxi/Peaklytics/app_pages/images/main_page.png")
...
def page2():
    ...
    if st.button("Try it"):
        ...
        if not market or not funding_total:
...
def page3():
    ...
    lottie_animation = load_lottiefile("/home/joud/code/parvxi/Peaklytics/app_pages/images/1729425524995.json")
    st_lottie(lottie_animation, height=400, key="loading")



def error_page():
     st.markdown("<h1 style='text-align: center;'>Oops! Something went wrong.</h1>", unsafe_allow_html=True)
     st.markdown("<h3 style='text-align: center;'>No data found or input data is invalid.</h3>", unsafe_allow_html=True)

    # Load and display the Lottie animation
     lottie_animation = load_lottiefile("/home/joud/code/parvxi/Peaklytics/app_pages/images/Animation.json")
     st_lottie(lottie_animation, height=250, key="error_animation")
